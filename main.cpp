      ...
      while(1) {
          if (turn % 2 == h) {
              ...
              while(move > 9 || field[move-1]=='X' || field[move-1]=='O') {
                  ...
                  SetColor(12, 0);
                  printspace(15);
                  cout << "** Please write true num(1-9) **\n";
                  printspace(34);
                  cout << "Your move:  ";
                  cin >> move;
              }
              ...
              if (turn>1) {
                  printspace(30);
                  cout << "You set " << a << " on " << move << endl;
              }
              printspace(35); cout << "Bot thinks";
...
int main() {
      ...
      while(choice == 'y') {
          ...
          SetColor(3, 0);
          printspace(32);
          cout << "You won " << p_wins << " times\n";
          printspace(32);
          cout << "Bot won " << b_wins << " times\n";
          printspace(32);
          cout << "Draw for " << draws << " times\n\n";
          SetColor(7, 0);
          printspace(32);
